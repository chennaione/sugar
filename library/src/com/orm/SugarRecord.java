            ...
            try {
                ...
                if (SugarRecord.class.isAssignableFrom(columnType)) {
                    ...
                    if (!"id".equalsIgnoreCase(column.getName())) {
                        ...
                        else if ("shadow$_klass_".equals(column.getName()) || "shadow$_monitor_".equals(column.getName()))
                        {
    ...
    void inflate(Cursor cursor) {
        ...
        for (Field field : columns) {
            ...
            try {
                ...
                else if ("shadow$_klass_".equals(field.getName()) || "shadow$_monitor_".equals(field.getName()))
                {
                    // skip this, it's generated by ART
                    continue;
                }
